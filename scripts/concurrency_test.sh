...
# JWT 토큰 (인자로 받거나 기본값)
JWT_TOKEN="Bearer eyJhbGciOiJIUzUxMiJ9.eyJzdWIiOiJ0ZXN0QHRlc3QuY29tIiwiYXV0aCI6IlJPTEVfSE9TVCIsImlhdCI6MTc2Nzg1NTEwMCwiZXhwIjoxNzY3ODU4NzAwfQ.h3fSnxOFd0gbcrPv8sAiXe8Iw78LOL5NiNzTU6DsQYkv0nnM2sE9RJf0gwPksTTqNuaUeQBxCdB6Mc0LoRBjaA"
...
make_reservation() {
    local request_id=$1
    local guest_count=$((RANDOM % 3 + 1))  # 1~3명 랜덤
